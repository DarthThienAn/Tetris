 ...
 */
public class TetrisView3 extends TileView {
	...
	class RefreshHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			TetrisView3.this.update();
			TetrisView3.this.invalidate();
		}
	 ...
	 * @param attrs
	 */
	public TetrisView3(Context context, AttributeSet attrs) {
		super(context, attrs);
		initTetrisView();
	}

	public TetrisView3(Context context, AttributeSet attrs, int defStyle) {
