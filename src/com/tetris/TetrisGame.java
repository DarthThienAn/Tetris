...
//        	Log.d(TAG, "Last: " + mLastTimedMove + " and now: " + now);
    ...
    public void inputCmd(int cmd)
    {
    	...
    	switch(cmd)
    	{
	    	...
	    	case 2:
	    	{
				...
				if(!checkCollision())
				{
		    		if (!((mTetrisBlock.y1 == ySize - 2) || (mTetrisBlock.y2 == ySize - 2) || (mTetrisBlock.y3 == ySize - 2) || (mTetrisBlock.y4 == ySize - 2)))
		    		{
	    	...
	    	case 4:
	        {
	        	...
	        	if (!((mTetrisBlock.x1 == (xSize - 2)) || (mTetrisBlock.x2 == (xSize - 2)) || (mTetrisBlock.x3 == (xSize - 2)) || (mTetrisBlock.x4 == (xSize - 2))))
	        	{
    ...
    {
//		Log.d(TAG, "CheckCollision");
//		Log.d(TAG, "y1: " + mTetrisBlock.y1);
//		Log.d(TAG, "y2: " + mTetrisBlock.y2);
//		Log.d(TAG, "y3: " + mTetrisBlock.y3);
//		Log.d(TAG, "y4: " + mTetrisBlock.y4);
    	//if it hits the bottom
    	if (mTetrisBlock.y1 > (ySize - 3) || mTetrisBlock.y2 > (ySize - 3) || mTetrisBlock.y3 > (ySize - 3) || mTetrisBlock.y4 > (ySize - 3))
        {
//    		Log.d(TAG, "WTF");
        	saveBlocks();
        	initNewBlock();
...
//	        		return;
    ...
    public void rotateClockwise()
    {
        ...
        //right side
        if (((mTetrisBlock.x1 > (xSize - 3)) || (mTetrisBlock.x2 > (xSize - 3)) || (mTetrisBlock.x3 > (xSize - 3)) || (mTetrisBlock.x4 > (xSize - 3))))
        {
        ...
        //bottom
        if ((mTetrisBlock.y1 == (ySize - 2)) || (mTetrisBlock.y2 == (ySize - 2)) || (mTetrisBlock.y3 == (ySize - 2)) || (mTetrisBlock.y4 == (ySize - 2)))
        		// || (mTetrisBlock.y2 == (ySize - 4)) || (mTetrisBlock.y3 == (ySize - 4)) || (mTetrisBlock.y4 == (ySize - 4))))
		{
        ...
        //IBLOCK, bottom
    	if ((mTetrisBlock.getBlockType() == IBLOCK) && (mTetrisBlock.y1 > ySize - 4))
		{
        ...
        //IBLOCK, left side
    	if ((mTetrisBlock.getBlockType() == IBLOCK) && (mTetrisBlock.x1 < 3))
		{
        ...
        //IBLOCK, right side
    	if ((mTetrisBlock.getBlockType() == IBLOCK) && (mTetrisBlock.x1 > xSize - 5))
		{
			if (mTetrisBlock.getOrientation() == 0)
			{
	    		mTetrisBlock.x1 = xSize - 3;
